...
const AboutMe = () => {
  ...
  const { isVisible: isVisualVibeVisible, elementRef: visualVibeRef } = useFadeInOnScroll();
  const { isVisible: isTeamMembersVisible, elementRef: teamMembersRef } = useFadeInOnScroll();
              ...
              <Grid item xs={6} sm={6} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div
                  style={{
                    ...
                    transform: isTeamMembersVisible ? 'none' : 'translateX(50px)',
                    transition: 'all 1s ease-out',
                  }}
                >
                  <ImageContainer>
                ...
                <Typography
                  ...
                  sx={{
                    color: '#ffffff', 
                    marginTop: 1,
                    animation: `${isTeamMembersVisible ? fadeInFromLeft : fadeOutFromLeft} 1s ease-out forwards`,
                  }}
                >
                  Nikunj Ranjan
                </Typography>
